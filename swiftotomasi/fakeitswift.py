...
for j in range(len(obj)):
    ...
    data=pd.read_excel('/home/fahmi/Documents/'+obj[j]+' nH free.xlsx')
    
    flux_dbb=[[],[],[]]
    Tin=np.linspace(0.1,3.0,75)
    for i in Tin:
